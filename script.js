...
function toDoList(toDo) {
    if (toDo === 'paint') {
        return function (name) {
            console.log('Can you please paint the room, ' + name);
        }
    } else if (toDo === 'spackle') {
        return function (name) {
            console.log ('Hey ' + name + ' can you spackle that crack?');
        }
    } else {
        return function (name) {
            console.log ('Hey ' + name + ' you bastard, get out of here!');
        }
    }
}

toDoList('paint')('Vince');
toDoList('spackle')('Vince');


function retirement(retirementAge) {
    var a = ' years left until you can retire';
...
var john = {
    ...
    presentation: function (style, timeOfDay) {
        if (style === 'formal') {
            ...
            console.log('Hey! What\'s up? I\'m ' + this.name + ' I am a ' + this.job + ' and I am ' + this.age + ' years old. Have a good ' + timeOfDay + '.');
        }
    }
};
